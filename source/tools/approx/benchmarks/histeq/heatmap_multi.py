...
executable = "../../../../../../perfect/suite/pa1/kernels/ser/histogram_equalization/histogram_equalization"
        ...
        for i in range(num_runs):
            try:
                ...
                snr_out = subprocess.check_output(["python", 
                                                error_script, 
                                                f"histeq_output.small.0.mat.{instr}.{bit*2}", 
                                                "../../../../../../perfect/suite/pa1/output/histeq_output.small.mat"])
